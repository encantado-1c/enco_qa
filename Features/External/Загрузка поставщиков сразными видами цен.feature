...
Функционал: Загрузка поставщиков сразными видами цен

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: Загрузка поставщиков сразными видами цен
